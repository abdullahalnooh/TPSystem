...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="flex flexfix items-center justify-center uppercase pt-2 bg-secondary pb-2">
            <div>
                <h3>TP Managment System</h3>
            </div>
            <div>
                <nav class="">
                    <a href="/" class="text-decoration-none text-dark">Home |</a>
                    <a href="{{route('products.index')}}" class="text-decoration-none text-dark">Products |</a>
                    <a href="{{route('products.create')}}" class="text-decoration-none text-dark">buy New Product |</a>
                </nav>
            </div>
        </div>
            @yield('content')
