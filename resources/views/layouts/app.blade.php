            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li>
                            <a href="{{route('products.index')}}" class="text-decoration-none nav-link ">Products |</a>                    
                        </li>
                        <li>
                            <a href="{{route('products.create')}}" class="text-decoration-none nav-link">buy New Product |</a>
                        </li>
